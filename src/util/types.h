...
static inline struct vec2_i32 name##_to_vec2_i32( const A a ) { const struct vec2_i32 b = { ( int32_t ) a.x, ( int32_t ) a.y }; return b; } \
static inline struct vec2_i64 name##_to_vec2_i64( const A a ) { const struct vec2_i64 b = { ( int64_t ) a.x, ( int64_t ) a.y }; return b; } \
static inline struct vec2_f32 name##_to_vec2_f32( const A a ) { const struct vec2_f32 b = { ( float )   a.x, ( float )   a.y }; return b; } \
static inline struct vec2_f64 name##_to_vec2_f64( const A a ) { const struct vec2_f64 b = { ( double )  a.x, ( double )  a.y }; return b; }
...
static inline struct vec3_i32 name##_to_vec3_i32( const A a ) { const struct vec3_i32 b = { ( int32_t ) a.x, ( int32_t ) a.y, ( int32_t ) a.z }; return b; } \
static inline struct vec3_i64 name##_to_vec3_i64( const A a ) { const struct vec3_i64 b = { ( int64_t ) a.x, ( int64_t ) a.y, ( int64_t ) a.z }; return b; } \
static inline struct vec3_f32 name##_to_vec3_f32( const A a ) { const struct vec3_f32 b = { ( float )   a.x, ( float )   a.y, ( float )   a.z }; return b; } \
static inline struct vec3_f64 name##_to_vec3_f64( const A a ) { const struct vec3_f64 b = { ( double )  a.x, ( double )  a.y, ( double )  a.z }; return b; }
...
static inline struct vec4_i32 name##_to_vec4_i32( const A a ) { const struct vec4_i32 b = { ( int32_t ) a.x, ( int32_t ) a.y, ( int32_t ) a.z, ( int32_t ) a.w }; return b; } \
static inline struct vec4_i64 name##_to_vec4_i64( const A a ) { const struct vec4_i64 b = { ( int64_t ) a.x, ( int64_t ) a.y, ( int64_t ) a.z, ( int64_t ) a.w }; return b; } \
static inline struct vec4_f32 name##_to_vec4_f32( const A a ) { const struct vec4_f32 b = { ( float )   a.x, ( float )   a.y, ( float )   a.z, ( float )   a.w }; return b; } \
static inline struct vec4_f64 name##_to_vec4_f64( const A a ) { const struct vec4_f64 b = { ( double )  a.x, ( double )  a.y, ( double )  a.z, ( double )  a.w }; return b; }
...
static inline struct quat_i32 name##_to_quat_i32( const A a ) { const struct quat_i32 b = { ( int32_t ) a.x, ( int32_t ) a.y, ( int32_t ) a.z, ( int32_t ) a.w }; return b; } \
static inline struct quat_i64 name##_to_quat_i64( const A a ) { const struct quat_i64 b = { ( int64_t ) a.x, ( int64_t ) a.y, ( int64_t ) a.z, ( int64_t ) a.w }; return b; } \
static inline struct quat_f32 name##_to_quat_f32( const A a ) { const struct quat_f32 b = { ( float )   a.x, ( float )   a.y, ( float )   a.z, ( float )   a.w }; return b; } \
static inline struct quat_f64 name##_to_quat_f64( const A a ) { const struct quat_f64 b = { ( double )  a.x, ( double )  a.y, ( double )  a.z, ( double )  a.w }; return b; }
...
static inline struct mat4_i32 name##_to_mat4_i32( const A a ) { const struct mat4_i32 b = { ( int32_t ) a.m00, ( int32_t ) a.m01, ( int32_t ) a.m02, ( int32_t ) a.m03, ( int32_t ) a.m10, ( int32_t ) a.m11, ( int32_t ) a.m12, ( int32_t ) a.m13, ( int32_t ) a.m20, ( int32_t ) a.m21, ( int32_t ) a.m22, ( int32_t ) a.m23, ( int32_t ) a.m30, ( int32_t ) a.m31, ( int32_t ) a.m32, ( int32_t ) a.m33 }; return b; } \
static inline struct mat4_i64 name##_to_mat4_i64( const A a ) { const struct mat4_i64 b = { ( int64_t ) a.m00, ( int64_t ) a.m01, ( int64_t ) a.m02, ( int64_t ) a.m03, ( int64_t ) a.m10, ( int64_t ) a.m11, ( int64_t ) a.m12, ( int64_t ) a.m13, ( int64_t ) a.m20, ( int64_t ) a.m21, ( int64_t ) a.m22, ( int64_t ) a.m23, ( int64_t ) a.m30, ( int64_t ) a.m31, ( int64_t ) a.m32, ( int64_t ) a.m33 }; return b; } \
static inline struct mat4_f32 name##_to_mat4_f32( const A a ) { const struct mat4_f32 b = { ( float )   a.m00, ( float )   a.m01, ( float )   a.m02, ( float )   a.m03, ( float )   a.m10, ( float )   a.m11, ( float )   a.m12, ( float )   a.m13, ( float )   a.m20, ( float )   a.m21, ( float )   a.m22, ( float )   a.m23, ( float )   a.m30, ( float )   a.m31, ( float )   a.m32, ( float )   a.m33 }; return b; } \
static inline struct mat4_f64 name##_to_mat4_f64( const A a ) { const struct mat4_f64 b = { ( double )  a.m00, ( double )  a.m01, ( double )  a.m02, ( double )  a.m03, ( double )  a.m10, ( double )  a.m11, ( double )  a.m12, ( double )  a.m13, ( double )  a.m20, ( double )  a.m21, ( double )  a.m22, ( double )  a.m23, ( double )  a.m30, ( double )  a.m31, ( double )  a.m32, ( double )  a.m33 }; return b; }
...
static inline struct fmat4_i32 name##_to_fmat4_i32( const A a ) { const struct fmat4_i32 b = { ( int32_t ) a.m[ 0 ], ( int32_t ) a.m[ 1 ], ( int32_t ) a.m[ 2 ], ( int32_t ) a.m[ 3 ], ( int32_t ) a.m[ 4 ], ( int32_t ) a.m[ 5 ], ( int32_t ) a.m[ 6 ], ( int32_t ) a.m[ 7 ], ( int32_t ) a.m[ 8 ], ( int32_t ) a.m[ 9 ], ( int32_t ) a.m[ 10 ], ( int32_t ) a.m[ 11 ], ( int32_t ) a.m[ 12 ], ( int32_t ) a.m[ 13 ], ( int32_t ) a.m[ 14 ], ( int32_t ) a.m[ 15 ] }; return b; } \
static inline struct fmat4_i64 name##_to_fmat4_i64( const A a ) { const struct fmat4_i64 b = { ( int64_t ) a.m[ 0 ], ( int64_t ) a.m[ 1 ], ( int64_t ) a.m[ 2 ], ( int64_t ) a.m[ 3 ], ( int64_t ) a.m[ 4 ], ( int64_t ) a.m[ 5 ], ( int64_t ) a.m[ 6 ], ( int64_t ) a.m[ 7 ], ( int64_t ) a.m[ 8 ], ( int64_t ) a.m[ 9 ], ( int64_t ) a.m[ 10 ], ( int64_t ) a.m[ 11 ], ( int64_t ) a.m[ 12 ], ( int64_t ) a.m[ 13 ], ( int64_t ) a.m[ 14 ], ( int64_t ) a.m[ 15 ] }; return b; } \
static inline struct fmat4_f32 name##_to_fmat4_f32( const A a ) { const struct fmat4_f32 b = { ( float )   a.m[ 0 ], ( float )   a.m[ 1 ], ( float )   a.m[ 2 ], ( float )   a.m[ 3 ], ( float )   a.m[ 4 ], ( float )   a.m[ 5 ], ( float )   a.m[ 6 ], ( float )   a.m[ 7 ], ( float )   a.m[ 8 ], ( float )   a.m[ 9 ], ( float )   a.m[ 10 ], ( float )   a.m[ 11 ], ( float )   a.m[ 12 ], ( float )   a.m[ 13 ], ( float )   a.m[ 14 ], ( float )   a.m[ 15 ] }; return b; } \
static inline struct fmat4_f64 name##_to_fmat4_f64( const A a ) { const struct fmat4_f64 b = { ( double )  a.m[ 0 ], ( double )  a.m[ 1 ], ( double )  a.m[ 2 ], ( double )  a.m[ 3 ], ( double )  a.m[ 4 ], ( double )  a.m[ 5 ], ( double )  a.m[ 6 ], ( double )  a.m[ 7 ], ( double )  a.m[ 8 ], ( double )  a.m[ 9 ], ( double )  a.m[ 10 ], ( double )  a.m[ 11 ], ( double )  a.m[ 12 ], ( double )  a.m[ 13 ], ( double )  a.m[ 14 ], ( double )  a.m[ 15 ] }; return b; }
