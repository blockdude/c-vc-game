...
#define _VEC2_FUNC_DECL_CAST_UTIL( A, name ) \
...
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2, vec2 );
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2i, vec2i );
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2_i32, vec2_i32 );
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2_i64, vec2_i64 );
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2_f32, vec2_f32 );
_VEC2_FUNC_DECL_CAST_UTIL( struct vec2_f64, vec2_f64 );

#define _VEC3_FUNC_DECL_CAST_UTIL( A, name ) \
...
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3, vec3 );
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3i, vec3i );
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3_i32, vec3_i32 );
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3_i64, vec3_i64 );
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3_f32, vec3_f32 );
_VEC3_FUNC_DECL_CAST_UTIL( struct vec3_f64, vec3_f64 );

#define _VEC4_FUNC_DECL_CAST_UTIL( A, name ) \
...
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4, vec4 );
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4i, vec4i );
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4_i32, vec4_i32 );
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4_i64, vec4_i64 );
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4_f32, vec4_f32 );
_VEC4_FUNC_DECL_CAST_UTIL( struct vec4_f64, vec4_f64 );

#define _QUAT_FUNC_DECL_CAST_UTIL( A, name ) \
...
_QUAT_FUNC_DECL_CAST_UTIL( struct quat, quat );
_QUAT_FUNC_DECL_CAST_UTIL( struct quati, quati );
_QUAT_FUNC_DECL_CAST_UTIL( struct quat_i32, quat_i32 );
_QUAT_FUNC_DECL_CAST_UTIL( struct quat_i64, quat_i64 );
_QUAT_FUNC_DECL_CAST_UTIL( struct quat_f32, quat_f32 );
_QUAT_FUNC_DECL_CAST_UTIL( struct quat_f64, quat_f64 );

#define _MAT4_FUNC_DECL_CAST_UTIL( A, name ) \
...
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4, mat4 );
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4i, mat4i );
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4_i32, mat4_i32 );
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4_i64, mat4_i64 );
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4_f32, mat4_f32 );
_MAT4_FUNC_DECL_CAST_UTIL( struct mat4_f64, mat4_f64 );

#define _FMAT4_FUNC_DECL_CAST_UTIL( A, name ) \
...
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4, fmat4 );
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4i, fmat4i );
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4_i32, fmat4_i32 );
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4_i64, fmat4_i64 );
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4_f32, fmat4_f32 );
_FMAT4_FUNC_DECL_CAST_UTIL( struct fmat4_f64, fmat4_f64 );
