...
#define _VEC2_FUNC_TEMPLATE_CAST(A, name) \
...
#define _VEC3_FUNC_TEMPLATE_CAST(A, name) \
...
#define _VEC4_FUNC_TEMPLATE_CAST(A, name) \
...
#define _QUAT_FUNC_TEMPLATE_CAST(A, name) \
...
#define _MAT4_FUNC_TEMPLATE_CAST(A, name) \
...
#define _FMAT4_FUNC_TEMPLATE_CAST(A, name) \
