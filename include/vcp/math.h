...
template<dimension N, typename T> constexpr bool equals(Vector<N, T> a, Vector<N, T> b, T epsilon);
...
template<typename T> constexpr Vector<3, T> rotate(Vector<3, T>, T pitch, T yaw, T roll, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
template<typename T> constexpr Vector<3, T> rotate(Vector<3, T>, Vector<3, T> euler);
template<typename T> constexpr Vector<3, T> euler(Quaternion<T>, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
template<typename T> constexpr Vector<3, T> euler(Matrix<3, 3, T>, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
template<typename T> constexpr Vector<3, T> euler(Matrix<4, 4, T>, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
...
template<typename T> constexpr Quaternion<T> orientation(T pitch, T yaw, T roll, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
...
template<typename T> constexpr Quaternion<T> orient(Quaternion<T>, T pitch, T yaw, T roll, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
template<typename T> constexpr Quaternion<T> orient(T pitch, T yaw, T roll, Quaternion<T>, Vector<3, T> a1 = Cardinal<3, T>::Z, Vector<3, T> a2 = Cardinal<3, T>::Y, Vector<3, T> a3 = Cardinal<3, T>::X);
